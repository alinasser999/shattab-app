...
class BatshTypography {
  ...
  static TextStyle get headlineLgMobile =>
      headlineLg.copyWith(fontSize: 26, height: 34 / 26);
  ...
  static TextStyle get titleMd =>
      _body(size: 18, weight: FontWeight.w600, lineHeight: 26);
  static TextStyle get bodyLg =>
      _body(size: 17, weight: FontWeight.w400, lineHeight: 26);
  static TextStyle get bodyMd =>
      _body(size: 15, weight: FontWeight.w400, lineHeight: 24);
  static TextStyle get bodySm =>
      _body(size: 13, weight: FontWeight.w400, lineHeight: 20);
  static TextStyle get labelLg =>
      _body(size: 15, weight: FontWeight.w600, lineHeight: 22);
  static TextStyle get labelMd =>
      _body(size: 13, weight: FontWeight.w500, lineHeight: 18);
  static TextStyle get labelSm =>
      _body(size: 11, weight: FontWeight.w500, lineHeight: 16);
